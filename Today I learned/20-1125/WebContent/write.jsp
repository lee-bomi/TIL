	...
	<div class="container">            <!-- 테이블 양옆에 빈칸까지 포함 -->
		...
		<form method="post" action="writeAction.jsp">
			<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					<tr>
						<td><input type="text" class="form-control" placeholder="글 제목" name="lbsTitle" maxlength="50"></td>
					</tr>
					<tr>
						<td><textarea class="form-control" placeholder="글 내용" name="lbsContent" maxlength="2048" style="height: 350px;"></textarea></td>
					</tr>
				</tbody>
